...
print '"SR","NODE","VM-CT","VMID","VMNAME","SOCKETS","CORES","MEMORY","DISK 0 NAME","DISK 0 SIZE","DISK 1 NAME","DISK 1 SIZE","DISK 2 NAME","DISK 2 SIZE","DISK 3 NAME","DISK 3 SIZE","DISK 4 NAME","DISK 4 SIZE,","DISK 5 NAME","DISK 5 SIZE","DISK 6 NAME","DISK 6 SIZE","DISK 7 NAME","DISK 7 SIZE","DISK 8 NAME","DISK 8 SIZE","DISK 9 NAME","DISK 9 SIZE","DISK 10 NAME","DISK 10 SIZE"';
print "\n";
